...
export interface components {
    schemas: {
        ...
        "paymentSource.mAccount": Omit<components["schemas"]["financial.transaction"], "paymentSource"> & {
            mAccount?: {
                /**
                 * @description 16-Digit account number that uniquely identifies the mAccount.
                 * @example 6279059726039800
        ...
        "paymentSource.mWallet": Omit<components["schemas"]["financial.transaction"], "paymentSource"> & {
            mWallet?: {
                /**
        ...
        "paymentSource.bulkDirectDebit": Omit<components["schemas"]["financial.transaction"], "paymentSource"> & {
            /**
        ...
        "paymentSource.directDebit": Omit<components["schemas"]["financial.transaction"], "paymentSource"> & {
            directDebit?: {
                /**
                 * @description BSB (Bank-State-Branch) number. The format is a string in the following format:&nbsp;‘999-999’.
                 * @example 062-205
        ...
        "paymentSource.token": Omit<components["schemas"]["financial.transaction"], "paymentSource"> & {
            /**
             * @description The text (GUID) that identifies the token
...
export interface operations {
    ...
    InboundDirectCreditWebhook: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.inboundDirectCreditWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    InboundDirectDebitWebhook: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.inboundDirectDebitWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    DirectEntryDishonour: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.directEntryDishonoursWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    PendingInboundRtgsImt: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.pendingrtgsImtWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    InboundRtgsImtStatus: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.InboundRtgsImtStatus"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    NppReturn: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.NppReturnWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    NppPaymentStatus: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.NppPaymentStatusWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
    ...
    NPPCreditRejections: {
        ...
        requestBody?: {
            content: {
                "application/json": unknown & components["schemas"]["event.NppCreditRejectionsWebhook"];
            };
        };
        responses: {
            /** @description Is the expected response upon successful receipt. If any other status code response is received, we will retry one more time only, after a 30 second pause. */
