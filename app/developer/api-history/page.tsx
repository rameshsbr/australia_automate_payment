...
type Col = "date" | "logId" | "endpoint" | "method" | "duration" | "status";
...
export default function ApiHistory() {
  ...
  function exportCSV() {
    const head = ["Date", "Log ID", "Endpoint", "HTTP method", "Duration", "Status"];
  ...
  return (
    <>
      <div className="flex items-center gap-2 mb-3">
        ...
        >
          <div className="text-sm space-y-1">
            <div className="px-2 py-1 rounded hover:bg-panel/60">Endpoint</div>
      ...
      <div className="bg-panel border border-outline/40 rounded-xl2 p-8 text-center text-subt">
        No API calls found
      </div>
    </>
  );
