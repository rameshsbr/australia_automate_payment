...
export default function BatchPayments() {
  ...
  const [columns, setColumns] = useState({ submitted: true, reference: true, status: true, createdBy: true, amount: true });
  ...
  return (
    <AppShell>
      ...
      <div className="flex items-center gap-2 mb-4">
        <input className="flex-1 bg-panel border border-outline/40 rounded-lg h-9 px-3 text-sm placeholder:text-subt/70" placeholder="Search batch payments..." />
